    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 flex items-center justify-between h-20">
        ...
        <Link to="/" className="flex items-center gap-4">
          <div className="h-14 w-14 rounded-full overflow-hidden border-2 border-emerald-700">
            <img src="/logo.png" alt="Monastery360 Logo" className="h-full w-full object-cover" />
          </div>
          <span className="text-3xl font-bold text-emerald-700">Monastery360</span>
        </Link>
